...
function save(req, res) {
    ...
    const farmacia_password = req.sanitize('farmacia_password').escape();
    ...
    req.checkBody("farmacia_password", "Por favor, introduza texto.").matches(/^[a-zA-Z0-9&@.$%\-,():;` ]+$/);
    ...
    if (errors) {
        ...
        if (nome != "NULL" && contacto != "NULL" && email != "NULL" && farmacia_password != "NULL" && /*nif != "NULL" && */ avaliacao != "NULL" && localizacao != "NULL" /*&& ativo != "NULL"*/) {
            var post = { 
                nome: nome, 
                contacto: contacto, 
                email: email,
                farmacia_password: farmacia_password,
